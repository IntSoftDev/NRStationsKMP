...
internal fun DataVersion.toVersion() =
    Version(id = -1, version = this.version, lastUpdate = this.lastUpdated)

internal fun Version.toDataVersion() =
    DataVersion(version = this.version, lastUpdated = this.lastUpdate)
